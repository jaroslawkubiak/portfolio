...
const portfolio = [
  {
    ...
    description: `This system is for a manufacturing company.
      It started with a customer base and simple orders, and for over 7 years of adding new functionalities, the system has:
      <ul>
      <li>- warehouse, register of purchases and suppliers</li>
      <li>- offers for customers sent by e-mail</li>
      <li>- register of customers and orders (adding, editing and deleting)
      ...
      <li>- separate login panel for drivers and customers.
      </ul>
      Everything is programmed as agreed with the client.`,
  },
  {
    ...
    tech: ["react", "redux", "js"],
    description:
      "I'm a huge fan and collector of Lego Star Wars minifigures. When my collection had about 80 figures I started to get a bit lost, I needed a list, I wanted something better than excel. Being a programmer, I wrote a web page with a database of my figures. This application is the second version, mainly written for learning JS and React. At the moment the database is in a JSON file, when I finish the Node.JS course I will be able to finish this application.",
  },
