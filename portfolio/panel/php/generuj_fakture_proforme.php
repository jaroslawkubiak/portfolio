...
$pdf->SetXY(5,40);
$pdf->Multicell(80, 10, 'FAKTURA PROFORMA', 0, 'L' ,0); //piewszy parametr - szerokosc, drugi wysokosc, trzeci teskt, czwarty czy ma byc ramka, 0 - brak, 1  -ramka. C - wyśrodkowane, ostatni parametr to tło
$pdf->SetXY(125,40);
...
if(($kurs_euro != '') && ($kurs_euro != 0))
	...
	$wartosc_brutto_fv = change($wartosc_brutto_fv);
...
$nazwa_pliku = 'faktura_proforma_'.$nr_fv.'.pdf';

$pdf->Output("../panel_dane/faktury_proformy/".$nazwa_pliku."", "F");
