...
$pdf->SetXY(5,40);
$pdf->Multicell(80, 10, 'FAKTURA', 0, 'L' ,0); //piewszy parametr - szerokosc, drugi wysokosc, trzeci teskt, czwarty czy ma byc ramka, 0 - brak, 1  -ramka. C - wysrodkowane, ostatni parametr to tlo
$pdf->SetXY(125,40);
...
//if(($kurs_euro != '') && ($kurs_euro != 0)) $waluta_na_fv2 = 'EUR';	else 
$waluta_na_fv2 = 'PLN';	
$szer_poczatkowa += $szer_ramki;
$pdf->SetXY($szer_poczatkowa, $wys_poczatkowa2);
...
$pdf->Output("../panel_dane/faktury/".$nazwa_pliku."", "F");
?>