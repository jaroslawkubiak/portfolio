...
$pytanie = mysqli_query($conn, "SELECT * FROM logowania_uzytkownikow ".$WARUNEK." ORDER BY ID DESC;");
...
if($tylko_nieudane == 'tak') echo '<div align="center"><a href="index.php?page=uzytkownicy_logowania&tylko_nieudane=nie">Pokaż wszystko</a></div><br>';
else echo '<div align="center"><a href="index.php?page=uzytkownicy_logowania&tylko_nieudane=tak">Pokaż tylko nieudane próby</a></div><br>';

echo '<table width="100%" align="center" border="0" class="tabela" cellpadding="1" cellspacing="1"><tr align="center" bgcolor="'.$kolor_tabeli.'" class="text">';
...
echo '<td width="30%">User Agent</td></tr>';
	...
	for ($x=1; $x<=$i; $x++)
		{
		if($status_logowania[$x] == 'true') $kolor_logowania = $kolor_bialy; else $kolor_logowania = '#f10000';
		echo '<tr class="text" align="center" bgcolor="'.$kolor_logowania.'"><td bgcolor="'.$kolor_tabeli.'" class="text">'.$x.'</td>';
